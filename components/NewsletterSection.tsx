  ...
  return (
    <section className="w-full py-20 bg-teal text-cream relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-site px-6 relative z-10">
        <FadeInView className="max-w-5xl mx-auto bg-dark/30 backdrop-blur-md rounded-3xl p-8 md:p-16 border border-white/10 shadow-2xl">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12">
            ...
            <div className="flex-1 w-full max-w-md">
              <form onSubmit={handleSubmit} className="flex flex-col sm:relative group gap-4 sm:gap-0">
                <input
                  type="email"
                  ...
                  className={`w-full bg-cream text-dark placeholder-dark/30 px-6 sm:px-8 py-5 rounded-xl sm:rounded-2xl font-sans text-lg focus:outline-none focus:ring-4 focus:ring-gold/30 shadow-2xl transition-all ${
                ...
                <button
                  type="submit"
                  disabled={status === 'success' || status === 'submitting'}
                  className={`sm:absolute sm:right-2 sm:top-2 sm:bottom-2 px-8 py-4 sm:py-0 rounded-xl flex items-center justify-center transition-all duration-500 font-bold uppercase tracking-widest text-xs min-h-[50px] shadow-lg sm:shadow-none ${
                    status === 'success' 
              ...
              <p className={`text-sm mt-4 pl-2 transition-all duration-500 font-sans text-center sm:text-left ${
